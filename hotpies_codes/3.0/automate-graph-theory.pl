...
system ("perl $bpath/3.0/automate_waterless.pl $bpath");
...
system ("echo 3.0 > contfile");
system ("perl $bpath/3.0/make_mat.pl $bpath");
...
system ("perl $bpath/3.0/all_degree.pl $bpath");
system ("perl $bpath/3.0/genip_clique.pl");
...
system ("perl $bpath/3.0/redo.pl");
system ("sh ./deg.sh");
system ("perl $bpath/3.0/automate-degrees.pl $bpath");
system ("perl $bpath/3.0/automate-clustering-coefficient.pl $bpath");

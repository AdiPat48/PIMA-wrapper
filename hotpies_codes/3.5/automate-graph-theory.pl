...
system ("perl $bpath/3.5/automate_waterless.pl $bpath");
...
system ("echo 3.5 > contfile");
system ("perl $bpath/3.5/make_mat.pl $bpath");
...
system ("perl $bpath/3.5/all_degree.pl $bpath");
system ("perl $bpath/3.5/genip_clique.pl");
...
system ("perl $bpath/3.5/redo.pl");
system ("sh ./deg.sh");
system ("perl $bpath/3.5/automate-degrees.pl $bpath");
system ("perl $bpath/3.5/automate-clustering-coefficient.pl $bpath");
